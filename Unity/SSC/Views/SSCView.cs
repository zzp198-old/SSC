...
namespace QOS.Unity.SSC.Views;

internal class SSCView : UIState
{
    internal Common.Views.Kits.UIContainer Container;
    internal UIList CharacterList;
    ...
    public override void OnActivate()
    {
        ...
        Container = new Common.Views.Kits.UIContainer
        {
        ...
        CharacterList.Append(CharacterCreationPanel);
        ...
        CharacterCreationPanel.Append(new UIDifficultyButton(Character, Language.GetText("UI.Creative"), null, PlayerDifficultyID.Creative,
        ...
        CreateButton.OnClick += (_, _) =>
        {
            ...
            Character.statLife = Character.statLifeMax = Common.QOS.SC.StartLife;
            Character.statMana = Character.statManaMax = Common.QOS.SC.StartMana;
    ...
    public void FlashList(TagCompound obj)
    {
        CharacterList.Clear();
        foreach (var tag in obj.Get<List<TagCompound>>(Common.QOSKit.ClientID.ToString()))
        {
            ...
            itemPlayButton.OnClick += (_, _) =>
            {
                ...
                mp.Write((byte)Common.QOS.PID.ChooseSSC);
