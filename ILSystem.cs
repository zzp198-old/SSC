...
public class ILSystem : ModSystem
{
    ...
    private static void ILHook2(ILContext il)
    {
        ...
        {
            if (Terraria.Main.LocalPlayer.HasBuff<Content.Spooky>())
    ...
    private static void ILHook4(ILContext il)
    {
        ...
        c.EmitDelegate(() =>
        {
            if (Terraria.Main.netMode == NetmodeID.MultiplayerClient && Terraria.Main.LocalPlayer.HasBuff<Content.Spooky>())
